        ...
        <div className="container mx-auto relative z-10" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[#141414] mb-2">SADHANA SAHAKARI BANK LTD</h2>
              <p className="text-[#7d7d7d] font-medium">Established 1984</p>
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-bold text-[#141414] mb-7 leading-tight"
              style={{
            ...
            <motion.p
              ...
              className="text-[#7d7d7d] mb-11 max-w-3xl mx-auto"
              style={{
                fontSize: "21px",
                lineHeight: 1.7,
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              width: "134px",
              height: "134px",
              background: "linear-gradient(113deg, #b6afa4 0%, #e7d8c5 100%)",
            ...
            {[
              {
                ...
                color: "linear-gradient(113deg, #7d7d7d 0%, #141414 100%)",
                delay: 0,
              },
              {
                icon: "trending_up",
                ...
                color: "linear-gradient(127deg, #b6afa4 0%, #7d7d7d 100%)",
                delay: 67,
              },
              {
                icon: "phone_android",
                ...
                color: "linear-gradient(113deg, #141414 0%, #7d7d7d 100%)",
                delay: 134,
              },
              {
                ...
                color: "linear-gradient(127deg, #7d7d7d 0%, #b6afa4 100%)",
                delay: 201,
              },
              {
                ...
                color: "linear-gradient(113deg, #b6afa4 0%, #141414 100%)",
                delay: 268,
              },
            ].map((service, index) => (
              <motion.div
              ...
              >
                <div className="p-8 text-center" style={{ padding: "23px 29px 25px 29px" }}>
                  <div className="mb-7">
                    <span className="material-icons text-[#7d7d7d]" style={{ fontSize: "48px" }}>
                      {service.icon}
                    </span>
                  </div>
                  <h3
                    className="font-bold text-[#141414] mb-5"
                    style={{
                      fontSize: "21px",
                      fontWeight: 525,
                  ...
                  <p
                    className="text-[#7d7d7d] leading-relaxed"
                    style={{
                      fontSize: "17px",
                      lineHeight: 1.7,
                      letterSpacing: "0.003em",
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            style={{
              ...
              width: "267px",
              height: "267px",
              background: "linear-gradient(113deg, #b6afa4 0%, #7d7d7d 100%)",
              transform: "rotate(-13deg)",
            }}
          />
          <div
            ...
            style={{
              ...
              width: "189px",
              height: "189px",
              background: "linear-gradient(127deg, #7d7d7d 0%, #b6afa4 100%)",
        ...
        <div className="container mx-auto relative z-10" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p
                className="text-[#7d7d7d] mb-11 leading-relaxed"
                style={{
                  fontSize: "19px",
                  lineHeight: 1.7,
                  letterSpacing: "0.003em",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-7 mb-11" style={{ gap: "23px 29px" }}>
                <div
                  className="bg-[#ffffff] rounded-2xl shadow-organic p-7 slightly-off-1"
                  style={{
                ...
                >
                  <div
                    className="font-bold text-[#7d7d7d] mb-2"
                    style={{
                      fontSize: "29px",
                      fontWeight: 725,
                ...
                <div
                  className="bg-[#ffffff] rounded-2xl shadow-organic p-7 slightly-off-2"
                  style={{
                    padding: "19px 23px 21px 23px",
                    borderRadius: "11px",
                  }}
              ...
              <div className="space-y-4">
                {["Jaripatka (where it all started)", "Gandhibag", "Ayodhya Nagar", "Maskasath", "Wadi"].map(
                  (branch, index) => (
                    ...
                    >
                      <div
                        className="bg-[#7d7d7d] rounded-full"
                        style={{
                          width: "3px",
                          height: "3px",
                        }}
            ...
            >
              <div
                className="rounded-3xl text-[#ffffff] relative overflow-hidden"
                style={{
