...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] relative noise-overlay">
      ...
      <section ref={contactRef} className="bg-[#ffffff] relative overflow-hidden" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
          ...
          >
            {branches.map((branch, index) => (
              <motion.div
                ...
                className={`card-organic ${branch.isHeadOffice ? "bg-gradient-to-br from-[#e7d8c5] to-white" : "bg-white"} ${index === 2 ? "slightly-off-3" : ""}`}
              >
                <div style={{ padding: "23px 29px 25px 29px" }}>
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3
                        className="font-bold text-[#141414] mb-2"
                        style={{
                          fontSize: "19px",
                          fontWeight: 525,
                          letterSpacing: "-0.01em",
                      ...
                      {branch.isHeadOffice && (
                        <span
                          className="inline-block px-3 py-1 bg-[#7d7d7d] text-white text-sm font-medium rounded-full mb-2"
                          style={{
                            fontSize: "13px",
                            fontWeight: 525,
      ...
      <section className="bg-[#ffffff]" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          ...
          >
            ...
            >
              <div className="text-center">
                <MapPin 
                  className="text-[#7d7d7d] mx-auto mb-4" 
                  style={{ 
                    fontSize: "67px",
                    width: "67px",
                    height: "67px"
                ...
                <p
                  className="text-[#7d7d7d] max-w-md mx-auto"
                  style={{
                    fontSize: "17px",
                    lineHeight: 1.6,
                  }}
