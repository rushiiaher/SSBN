          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <div
                ...
                style={{ fontSize: "19px", lineHeight: 1.7, color: "#7d7d7d" }}
              >
                <p>
            ...
            {branches.map((branch, index) => (
              <motion.div
                ...
                className={`card-organic ${
                  branch.isHeadOffice ? "bg-gradient-to-br from-[#e7d8c5] to-white" : "bg-white"
                ...
                <div style={{ padding: "23px 29px 25px 29px" }}>
                  <div className="flex items-start space-x-4 mb-5">
                    ...
                    <div className="flex-1">
                      <h3
                        className="font-bold text-[#141414] mb-1"
                        style={{
                          fontSize: "19px",
                          fontWeight: 525,
                          letterSpacing: "-0.01em",
                      ...
                      {branch.isHeadOffice && (
                        <span
                          className="inline-block px-3 py-1 bg-[#7d7d7d] text-white text-sm font-medium rounded-full"
                          style={{
                            fontSize: "13px",
                            fontWeight: 525,
        ...
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          ...
          >
            <div className="card-organic text-center" style={{ padding: "29px 23px 31px 23px" }}>
              ...
              <div
                className="space-y-2 text-[#7d7d7d]"
                style={{
                  fontSize: "17px",
                  lineHeight: 1.6,
                  fontFamily: "var(--font-mono)",
            ...
            <div className="card-organic text-center" style={{ padding: "29px 23px 31px 23px" }}>
              <div className="mb-7">
                <span 
                  ...
                  style={{ 
                    fontSize: "43px",
                    background: "linear-gradient(113deg, #141414 0%, #7d7d7d 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text"
                  }}
