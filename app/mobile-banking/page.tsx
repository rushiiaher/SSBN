...
export default function MobileBankingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] relative noise-overlay">
        ...
        <div className="container mx-auto relative z-10" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p
                className="text-[#7d7d7d] mb-11 leading-relaxed max-w-2xl mx-auto lg:mx-0"
                style={{
                  fontSize: "21px",
                  lineHeight: 1.7,
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-2 text-[#7d7d7d] hover:bg-gray-50 px-8 py-3 rounded-lg transition-all duration-300 flex items-center justify-center"
                  style={{
                    borderColor: "#7d7d7d",
                    fontSize: "17px",
                    fontWeight: 525,
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3">
                      <div
                        className="bg-[#ffffff] bg-opacity-20 rounded-full flex items-center justify-center"
                        style={{
                          width: "7px",
                          height: "7px",
                        }}
      ...
      {/* Features Section */}
      <section ref={featuresRef} className="bg-[#ffffff] relative overflow-hidden" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
            ...
            {appFeatures.map((feature, index) => (
              ...
              >
                <div className="text-center h-full flex flex-col" style={{ padding: "23px 29px 25px 29px" }}>
                  ...
                  <p
                    className="text-[#7d7d7d] leading-relaxed mb-6 flex-grow"
                    style={{
                      fontSize: "17px",
                      lineHeight: 1.7,
                      letterSpacing: "0.003em",
                  ...
                  <div className="space-y-2">
                    {feature.features.map((item, itemIndex) => (
                      <div key={itemIndex} className="flex items-center justify-center space-x-2">
                        <div
                          className="bg-[#7d7d7d] rounded-full flex-shrink-0"
                          style={{
                            width: "3px",
                            height: "3px",
                          }}
          ...
          >
            <div className="flex items-start space-x-4">
              <div className="mt-1 flex-shrink-0">
                <AlertTriangle className="w-8 h-8 text-[#e7d8c5]" />
              </div>
              <div>
                <h3
                ...
                <p
                  className="text-[#e7d8c5] leading-relaxed"
                  style={{
                    fontSize: "17px",
                    lineHeight: 1.7,
                  }}
      ...
      {/* Download Section */}
      <section ref={downloadRef} className="bg-[#ffffff]" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
              ...
              >
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full border-2 text-[#7d7d7d] hover:bg-gray-50 py-3 rounded-lg transition-all duration-300 flex items-center justify-center"
                    style={{
                      borderColor: "#7d7d7d",
                      fontSize: "17px",
                      fontWeight: 525,
      ...
      <section ref={termsRef} className="relative overflow-hidden" style={{
        ...
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          ...
          <motion.div
            ...
            className="mt-12 text-[#ffffff] relative overflow-hidden"
            style={{
              background: "linear-gradient(113deg, #7d7d7d 0%, #141414 100%)",
              padding: "37px 43px 39px 43px",
              borderRadius: "19px",
