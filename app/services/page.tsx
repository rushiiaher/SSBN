...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] relative noise-overlay">
      ...
      {/* Loans Section */}
      <section id="loans" ref={loansRef} className="bg-[#ffffff] relative overflow-hidden" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
              ...
              >
                <div className="h-full flex flex-col" style={{ padding: "23px 29px 25px 29px" }}>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 text-center sm:text-left">
                    <h3
                      className="font-bold text-[#141414] mb-2 sm:mb-0"
                      style={{
                        fontSize: "21px",
                        fontWeight: 525,
                        letterSpacing: "-0.01em",
                    ...
                    <span
                      className="px-3 py-1 bg-[#7d7d7d] text-white text-sm font-medium rounded-full mx-auto sm:mx-0 inline-block"
                      style={{
                        fontSize: "13px",
                        fontWeight: 525,
                  ...
                  <p
                    className="text-[#7d7d7d] mb-6 leading-relaxed text-center flex-grow"
                    style={{
                      fontSize: "17px",
                      lineHeight: 1.7,
                      letterSpacing: "0.003em",
      ...
      <section id="accounts" ref={accountsRef} className="bg-[#ffffff]" style={{
        paddingTop: "89px",
        paddingBottom: "73px",
      }}>
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
            ...
            {accountTypes.map((account, index) => (
              ...
              >
                <div className="text-center" style={{ padding: "23px 29px 25px 29px" }}>
                  ...
                  <p
                    className="text-[#7d7d7d] leading-relaxed mb-6"
                    style={{
                      fontSize: "17px",
                      lineHeight: 1.7,
                      letterSpacing: "0.003em",
      ...
      <section id="digital" ref={digitalRef} className="relative overflow-hidden" style={{
        ...
        <div className="container mx-auto" style={{ maxWidth: "1240px", paddingInline: "23px" }}>
          ...
          <motion.div
            ...
            className="text-[#ffffff] text-center relative overflow-hidden"
            style={{
              background: "linear-gradient(113deg, #7d7d7d 0%, #141414 100%)",
              padding: "37px 43px 39px 43px",
              borderRadius: "19px",
